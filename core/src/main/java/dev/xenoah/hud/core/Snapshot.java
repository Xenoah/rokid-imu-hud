...
public final class Snapshot {
    ...
    public enum CalibrationQuality { PENDING, STANDARD, RELAXED, PROVISIONAL }
    public enum CalibrationReason { COLLECTING, WAIT_GYRO, POSE_DELAY, GYRO_MOVING,
        ...
        RELAXED_LIMITS, DEADLINE, WAIT_ACCEL }
    ...
    public double calibrationElapsedSec;
    public boolean calibrationRelaxed;
    public CalibrationQuality calibrationQuality=CalibrationQuality.PENDING;
    ...
    public void copyFrom(Snapshot s) {
        ...
        calibrationElapsedSec=s.calibrationElapsedSec;calibrationRelaxed=s.calibrationRelaxed;
        calibrationQuality=s.calibrationQuality;
